...
The dataset is available at [export.verifieralliance.org/?prefix=v2/](https://export.verifieralliance.org/?prefix=v2/). All files of the v2 format are stored under the `v2/` prefix.
